...
void RadioInterface::applyModemConfig()
{
    ...
    while (!validConfig)
    {
        LOG_INFO("loraConfig.use_preset= %d ,loraConfig.modem_preset= %d\n",loraConfig.use_preset,loraConfig.modem_preset);
        ...
        {
            LOG_WARN("spread_factor= %d ,coding_rate= %d,bandwidth= %d\n",loraConfig.spread_factor,loraConfig.coding_rate,loraConfig.bandwidth);
